...
FName UCommand::GetID() const { return ID; }

FText UCommand::GetText_Implementation() const { return Text; }

bool UCommand::IsEnabled_Implementation() const { return true; }
...
FText UCommand::GetOriginalText() const { return Text; }
