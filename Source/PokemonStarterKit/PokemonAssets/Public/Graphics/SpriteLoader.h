...
class POKEMONASSETS_API USpriteLoader : public UBlueprintFunctionLibrary
{
  ...
  public:
    ...
    UFUNCTION(BlueprintCallable, Category = "Sprites|Pokémon",
              meta = (CallableWithoutWorldContext, Latent, LatentInfo = LatentActionInfo))
    static FVoidCoroutine AsyncGetPokemonBattleSprite(const TScriptInterface<IPokemon> &Pokemon,
                                                      FBattleRender &OutRender, bool bBack = false,
                                                      FLatentActionInfo LatentActionInfo = FLatentActionInfo());

    static UE5Coro::TCoroutine<FBattleRender> AsyncGetPokemonBattleSprite(const TScriptInterface<IPokemon> &Pokemon,
                                                                          bool bBack = false,
