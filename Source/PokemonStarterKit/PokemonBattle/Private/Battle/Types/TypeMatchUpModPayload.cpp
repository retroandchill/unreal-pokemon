...
FTypeMatchUpModData::FTypeMatchUpModData(const TScriptInterface<IBattler> &User,
                                         const TScriptInterface<IBattler> &Target, FName AttackingType,
                                         float Multiplier)
    : User(User), Target(Target), AttackingType(AttackingType), Multiplier(Multiplier) {
}

UTypeMatchUpModPayload *UTypeMatchUpModPayload::Create(const TScriptInterface<IBattler> &User,
                                                       const TScriptInterface<IBattler> &Target, FName AttackingType,
                                                       float Multiplier) {
