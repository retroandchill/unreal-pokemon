...
struct POKEMONBATTLE_API FTypeMatchUpModData
{
     ...
     */
    FTypeMatchUpModData(const TScriptInterface<IBattler> &User, const TScriptInterface<IBattler> &Target,
                        FName AttackingType, float Multiplier);
};
...
class POKEMONBATTLE_API UTypeMatchUpModPayload : public UObject
{
  ...
  public:
     ...
     */
    static UTypeMatchUpModPayload *Create(const TScriptInterface<IBattler> &User,
