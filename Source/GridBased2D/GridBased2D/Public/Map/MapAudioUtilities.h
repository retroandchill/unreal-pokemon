...
public:
	...
	static void PlayBackgroundMusic(UObject* WorldContext, USoundBase* BGM, float VolumeMultiplier = 1, float PitchMultiplier = 1);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sound|Music", meta = (WorldContext = WorldContext, AdvancedDisplay="FadeOutDuration"))
