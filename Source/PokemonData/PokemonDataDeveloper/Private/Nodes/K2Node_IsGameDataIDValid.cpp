...
void UK2Node_IsGameDataIDValid::Initialize(UScriptStruct *NodeStruct) { StructType = NodeStruct; }
...
FText UK2Node_IsGameDataIDValid::GetNodeTitle(ENodeTitleType::Type TitleType) const {
    if (StructType) {
        ...
        return FText::FormatNamed(NSLOCTEXT("K2Node", "IsGameDataIDValid_NodeTitleFormat", "Is {ClassName} ID Valid?"),
...
bool UK2Node_IsGameDataIDValid::IsNodePure() const { return true; }
