...
IMPLEMENT_COMPLEX_AUTOMATION_TEST(GrowthRateFluctuatingTest, "Tests.Exp.GrowthRateFluctuatingTest",
...
void GrowthRateFluctuatingTest::GetTests(TArray<FString>& OutBeautifiedNames, TArray<FString>& OutTestCommands) const {
	OutBeautifiedNames.Add("Tests.Exp.GrowthRateFluctuatingTest: Level = 1");
	OutTestCommands.Add("1");

	OutBeautifiedNames.Add("Tests.Exp.GrowthRateFluctuatingTest: Level = 2-14");
	OutTestCommands.Add(FString::FromInt(FMath::RandRange(2, 14)));

	OutBeautifiedNames.Add("Tests.Exp.GrowthRateFluctuatingTest: Level = 15");
	OutTestCommands.Add("15");

	OutBeautifiedNames.Add("Tests.Exp.GrowthRateFluctuatingTest: Level = 16");
	OutTestCommands.Add("15");

	OutBeautifiedNames.Add("Tests.Exp.GrowthRateFluctuatingTest: Level = 17-34");
	OutTestCommands.Add(FString::FromInt(FMath::RandRange(17, 34)));

	OutBeautifiedNames.Add("Tests.Exp.GrowthRateFluctuatingTest: Level = 35");
	OutTestCommands.Add("35");

	OutBeautifiedNames.Add("Tests.Exp.GrowthRateFluctuatingTest: Level = 36");
	OutTestCommands.Add("36");

	OutBeautifiedNames.Add("Tests.Exp.GrowthRateFluctuatingTest: Level = 37-99");
	OutTestCommands.Add(FString::FromInt(FMath::RandRange(37, 99)));

	OutBeautifiedNames.Add("Tests.Exp.GrowthRateFluctuatingTest: Level = 100");
