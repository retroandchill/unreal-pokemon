...
void UPokemonTestUtilities::CreateMockParty(UObject *WorldContext) {
    ...
    Player->AddPokemonToParty(
        UConstructionUtilities::CreateNewPokemon({.Species = FName("SAMUROTT"),
                                                  .Level = 100,
                                                  .Gender = Male,
                                                  .Shiny = false,
                                                  .IVs = {{"HP", 31},
    ...
    Player->AddPokemonToParty(
        UConstructionUtilities::CreateNewPokemon({.Species = FName("EMBOAR"),
                                                  .Level = 100,
                                                  .Gender = Female,
                                                  .Shiny = true,
                                                  .IVs = {{"HP", 31},
    ...
    Player->AddPokemonToParty(
        UConstructionUtilities::CreateNewPokemon({.Species = FName("SERPERIOR"),
                                                  .Level = 100,
                                                  .Gender = Female,
                                                  .Shiny = false,
                                                  .IVs = {{"HP", 31},
