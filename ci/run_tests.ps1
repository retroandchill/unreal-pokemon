...
& "${unreal_engine_location}/UnrealEditor-Win64-DebugGame-Cmd.exe" "${location}/UnrealPokemon.uproject" -clientconfig=DebugGame -nosplash -unattended -nullrhi -execcmds="automation runtests UnrealPokemon,ShutdownAfterTests" -log -ReportOutputPath="${$location}/TestResults"
