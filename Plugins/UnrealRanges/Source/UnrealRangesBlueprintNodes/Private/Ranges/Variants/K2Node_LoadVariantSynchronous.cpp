...
void UK2Node_LoadVariantSynchronous::AllocateDefaultPins() {
    ...
    CreatePin(EGPD_Input, UEdGraphSchema_K2::PC_Wildcard, UE::Ranges::PN_SoftReference);
    CreatePin(EGPD_Output, UEdGraphSchema_K2::PC_Exec, UEdGraphSchema_K2::PN_Then);
    CreatePin(EGPD_Output, UEdGraphSchema_K2::PC_Exec, UE::Ranges::PN_LoadFailed);
...
bool UK2Node_LoadVariantSynchronous::IsConnectionDisallowed(const UEdGraphPin *MyPin, const UEdGraphPin *OtherPin,
    ...
    if (OtherPin->PinType.PinCategory == UEdGraphSchema_K2::PC_Struct) {
        ...
        auto Result = UE::Optionals::OfNullable(Struct) |
                      ...
                      UE::Optionals::Map(GetStructFunction) |
...
void UK2Node_LoadVariantSynchronous::ExpandNode(FKismetCompilerContext &CompilerContext, UEdGraph *SourceGraph) {
    ...
    auto FailedPin = FindPinChecked(UE::Ranges::PN_LoadFailed);
    ...
    auto CallCreateThenPin = CallCreateVariant->FindPinChecked(UE::Ranges::PN_True);
    auto CallCreateFailedPin = CallCreateVariant->FindPinChecked(UE::Ranges::PN_False);
