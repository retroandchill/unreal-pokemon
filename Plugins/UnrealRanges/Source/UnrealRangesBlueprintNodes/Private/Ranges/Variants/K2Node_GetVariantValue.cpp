...
UK2Node_VariantCastBase::FCastFunctionInfo UK2Node_GetVariantValue::GetPerformCastNode(FKismetCompilerContext& CompilerContext, UEdGraph* SourceGraph) {
    ...
    return {CallCreateVariant, CallCreateVariant->FindPinChecked(Variant_ParamName), CallCreateVariant->FindPinChecked(Object_ParamName)};
}
