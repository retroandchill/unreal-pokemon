...
FScopedTimeDilationFactor::FScopedTimeDilationFactor(const UObject *WorldContextObject, float Factor) noexcept : WorldContextObject(WorldContextObject), Factor(Factor) {
