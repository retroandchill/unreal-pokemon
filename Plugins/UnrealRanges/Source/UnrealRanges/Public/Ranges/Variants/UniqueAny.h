...
namespace UE::Ranges {
     ...
     * @class FUniqueAny
     *
     * @brief A type-safe container for any single value of any type, which ensures unique ownership of the contained value.
     *
     * FUniqueAny allows storing any object, while providing unique ownership semantics (non-copyable, movable).
     * It leverages small object optimization to store small objects directly inside the FUniqueAny instance, and dynamically
     * allocates memory for larger objects.
     */
    ...
    public:
         ...
         *
         * Initializes an empty FUniqueAny instance. The object constructed with this constructor does not hold any value.
         */
        FUniqueAny() = default;
         ...
         *
         * This constructor allows for the direct in-place construction of an object of type T within the FUniqueAny instance.
         * It utilizes perfect forwarding to pass arguments Args to the constructor of type T.
         *
         ...
         *
         * Constructs an FUniqueAny instance by transferring the ownership of the value from another FUniqueAny instance.
         * The other instance will be left in an empty state after the move.
         *
        ...
        /**
         * @brief Overloads the assignment operator to facilitate the correct transfer of ownership for the contained value.
         *
         ...
         *
         * This method checks if the stored value's type matches the specified type T. If it does, it returns a reference
         * to the stored value, wrapped in a TOptional. If the types do not match, it returns an empty TOptional.
         *
         * @return TOptional<T&> containing a reference to the stored value if the type matches, otherwise an empty TOptional.
         */
        template <typename T>
        TOptional<T&> TryGet() {
            if (GetType() != typeid(T)) {
