...
namespace UE::Ranges {
    /**
     * Template class to create a thin wrapper around function pointers. This is mainly here because I don't like the
     * syntax of raw function pointers.
     *
     ...
     * It stores pointers to member functions and allows the bound member function to be called with appropriate
     * arguments.
     *
    ...
    class TFunctionPtr<R(A...)> {
      public:
         ...
         */
        constexpr FunctionPtrType Get() const {
            return Function;
        }
         ...
         * @return The raw function pointer value
         */
        constexpr operator FunctionPtrType() const {
            return Function;
        }
         ...
         * @return Are the two function pointers the same
         */
        constexpr bool operator==(FunctionPtrType Other) const {
    ...
    class TFunctionPtr<R (T::*)(A...)> {
      public:
        ...
        /**
         * Dereferencing operator used for making an invocation to this member function pointer (e.g.
         * (Obj.*this)(Args...)).
         *
