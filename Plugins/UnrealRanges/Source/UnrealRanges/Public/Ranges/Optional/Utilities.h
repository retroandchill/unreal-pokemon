...
namespace UE::Optionals {
     ...
     * If the optional type is a subclass, the method returns the value obtained by the `Get` method of the optional with `nullptr` as a parameter.
     * Otherwise, it returns the value obtained by the `GetPtrOrNull` method.
     *
     * @tparam T The optional type
     * @param Optional The optional object from which to retrieve the nullable value.
     * @return The nullable value contained within the optional object. The exact return type depends on the type of the optional.
     */
    template <typename T>
