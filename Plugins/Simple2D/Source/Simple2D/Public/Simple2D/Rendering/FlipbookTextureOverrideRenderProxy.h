...
namespace Simple2D {
    ...
    public:
#if WITH_EDITOR
        FFlipbookTextureOverrideRenderProxy(const FMaterialRenderProxy* InParent, const UTexture* InBaseTexture, FAdditionalSpriteTextureArray InAdditionalTextures, const FFlipbookRenderSceneProxyTextureOverrideMap& InTextureOverrideList);
#else
        FFlipbookTextureOverrideRenderProxy(const FMaterialRenderProxy* InParent, const UTexture* InBaseTexture, FAdditionalSpriteTextureArray InAdditionalTextures);
#endif
