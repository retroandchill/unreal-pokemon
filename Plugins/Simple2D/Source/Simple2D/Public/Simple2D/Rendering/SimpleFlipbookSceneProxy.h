...
#if WITH_EDITOR
        void SetTransientTextureOverride_RenderThread(const UTexture* InTextureToModifyOverrideFor, const UTexture* InOverrideTexture);
#endif

    protected:
        void GetDynamicMeshElementsForView(const FSceneView* View, int32 ViewIndex, FMeshElementCollector& Collector) const;
        ...
        FFlipbookTextureOverrideRenderProxy* GetCachedMaterialProxyForSection(FMeshElementCollector& Collector, int32 SectionIndex, FMaterialRenderProxy* ParentMaterialProxy) const;
