...
Simple2D::FSimpleFlipbookVertexFactory::FSimpleFlipbookVertexFactory(ERHIFeatureLevel::Type FeatureLevel) : FLocalVertexFactory(FeatureLevel, "FSimpleFlipbookVertexFactory") {
}
