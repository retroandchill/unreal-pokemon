...
namespace Simple2D {
...
#if WITH_EDITOR
    FFlipbookTextureOverrideRenderProxy::FFlipbookTextureOverrideRenderProxy(
        const FMaterialRenderProxy *InParent, const UTexture *InBaseTexture,
    ...
    void FFlipbookTextureOverrideRenderProxy::Reinitialize(const FMaterialRenderProxy *InParent,
                                                           const UTexture *InBaseTexture,
                                                           FAdditionalSpriteTextureArray InAdditionalTextures,
                                                           int32 NewRows, int32 NewColumns, int32 NewFrameNumber) {
    ...
    const FMaterial *
    FFlipbookTextureOverrideRenderProxy::GetMaterialNoFallback(ERHIFeatureLevel::Type InFeatureLevel) const {
        return Parent->GetMaterialNoFallback(InFeatureLevel);
    }

    const FMaterialRenderProxy *
    FFlipbookTextureOverrideRenderProxy::GetFallback(ERHIFeatureLevel::Type InFeatureLevel) const {
