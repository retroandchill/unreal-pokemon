...
#define IMAGE_PLUGIN_BRUSH( RelativePath, ... ) FSlateImageBrush( FSimple2DStyle::InContent( RelativePath, ".png" ), __VA_ARGS__ )
#define IMAGE_PLUGIN_BRUSH_SVG( RelativePath, ... ) FSlateVectorImageBrush( FSimple2DStyle::InContent( RelativePath, ".svg" ), __VA_ARGS__ )
...
namespace Simple2D {
...

	{
		...
		StyleSet->Set("ClassIcon.SimpleFlipbook", new IMAGE_PLUGIN_BRUSH_SVG("Icons/AssetIcons/PaperFlipbookActor_16", Icon16x16));
		StyleSet->Set("ClassThumbnail.SimpleFlipbook", new IMAGE_PLUGIN_BRUSH_SVG("Icons/AssetIcons/PaperFlipbookActor_64", Icon64x64));
		StyleSet->Set("ClassIcon.SimpleFlipbookComponent", new IMAGE_PLUGIN_BRUSH_SVG("Icons/AssetIcons/PaperFlipbookActor_16", Icon16x16));
		StyleSet->Set("ClassThumbnail.SimpleFlipbookComponent", new IMAGE_PLUGIN_BRUSH_SVG("Icons/AssetIcons/PaperFlipbookActor_64", Icon64x64));
		StyleSet->Set("ClassIcon.SimpleFlipbookActor", new IMAGE_PLUGIN_BRUSH_SVG("Icons/AssetIcons/PaperFlipbookActor_16", Icon16x16));
		StyleSet->Set("ClassThumbnailSimpleFlipbookActor", new IMAGE_PLUGIN_BRUSH_SVG("Icons/AssetIcons/PaperFlipbookActor_64", Icon64x64));
