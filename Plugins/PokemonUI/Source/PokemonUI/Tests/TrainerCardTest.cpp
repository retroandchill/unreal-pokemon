...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(TrainerCardTest, "Tests.TrainerCardTest",
...
bool TrainerCardTest::RunTest(const FString &Parameters) {
    ...
    TWidgetPtr<UTrainerCardScreen> Screen(CreateWidget<UTrainerCardScreen>(World, WidgetClass));
