...
UPaperFlipbookUserWidget::UPaperFlipbookUserWidget(const FObjectInitializer &ObjectInitializer)
    : Super(ObjectInitializer), SourceFlipbook(nullptr), bAutoPlay(true), PlayRate(1.0f), bLooping(true),
      ColorAndOpacity(FLinearColor::White), bOverrideContentSize(false), DesiredSize(0.f, 0.f) {
}
