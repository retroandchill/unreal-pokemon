 ...
 */
enum class EAsyncWidgetLayerState : uint8 { Canceled, Initialize, AfterPush };
...
class COMMONGAME_API UPrimaryGameLayout : public UCommonUserWidget {
  ...
  public:
    ...
    PushWidgetToLayerStackAsync(FGameplayTag LayerName, bool bSuspendInputUntilComplete,
