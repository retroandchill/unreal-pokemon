...
class RPGMENUS_API URPGLocalPlayer : public ULocalPlayer
{
  ...
  public:
    DECLARE_MULTICAST_DELEGATE_TwoParams(FPlayerControllerSetDelegate, URPGLocalPlayer *LocalPlayer,
                                         APlayerController *PlayerController);
    RETRO_MULTICAST_DELEGATE_MEMBER(FPlayerControllerSetDelegate, OnPlayerControllerSet)

    DECLARE_MULTICAST_DELEGATE_TwoParams(FPlayerStateSetDelegate, URPGLocalPlayer *LocalPlayer,
