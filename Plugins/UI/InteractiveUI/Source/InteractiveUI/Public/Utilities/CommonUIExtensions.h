...
class INTERACTIVEUI_API UCommonUIExtensions : public UBlueprintFunctionLibrary
{
  ...
  public:
	...
	static void PushStreamedContentToLayer(const ULocalPlayer* LocalPlayer, UPARAM(meta = (Categories = "UI.Layer")) FGameplayTag LayerName, UPARAM(meta = (AllowAbstract = false)) TSoftClassPtr<UCommonActivatableWidget> WidgetClass);
