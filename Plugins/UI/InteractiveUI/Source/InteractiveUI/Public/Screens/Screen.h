...
namespace RPG::Menus
{
     ...
     */
    INTERACTIVEUI_API const UE_DECLARE_GAMEPLAY_TAG_EXTERN(PrimaryMenuLayerTag);

    /**
     * The native tag assigned to any overlay layers layer for display
     */
    INTERACTIVEUI_API const UE_DECLARE_GAMEPLAY_TAG_EXTERN(OverlayMenuLayerTag);
...
class INTERACTIVEUI_API UScreen : public UCommonActivatableWidget
{
    GENERATED_BODY()
