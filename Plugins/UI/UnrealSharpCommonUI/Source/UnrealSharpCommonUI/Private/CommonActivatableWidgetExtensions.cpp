...
TArray<FUIActionBindingHandle> UCommonActivatableWidgetExtensions::GetActionBindings(
    const UCommonActivatableWidget *Widget)
{
    return Widget->GetActionBindings();
}

FUIActionBindingHandle UCommonActivatableWidgetExtensions::RegisterUIActionBinding(
    UCommonActivatableWidget *Widget, const FCSBindUIActionArgs &BindActionArgs)
{
