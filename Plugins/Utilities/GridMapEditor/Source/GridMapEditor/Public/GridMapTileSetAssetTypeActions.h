...
class GRIDMAPEDITOR_API FGridMapTileSetAssetTypeActions : public FAssetTypeActions_Base
{
  public:
    ...
    // EditWithinLevelEditor = TSharedPtr<IToolkitHost>()) override; virtual bool HasActions(const TArray<UObject*>&
    // InObjects) const override { return true; } virtual void GetActions(const TArray<UObject*>& InObjects, struct
