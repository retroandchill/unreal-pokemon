...
class MAPMETADATA_API UTerrainTagUtilities : public UBlueprintFunctionLibrary {
  ...
  public:
     ...
     */
    UFUNCTION(BlueprintPure, Category = TerrainTags, meta = (AutoCreateRefTerm = Tag, WorldContext = WorldContext))
    ...
    static bool HasAnyTerrainTag(const UObject *WorldContext, const FGameplayTagContainer &Tags,
     ...
     */
    UFUNCTION(BlueprintPure, Category = TerrainTags, meta = (AutoCreateRefTerm = Tags))
    static bool HasAllTerrainTags(const UObject *WorldContext, const FGameplayTagContainer &Tags,
