...
class AUTOMATIONTESTHELPERS_API UActorUtilities : public UBlueprintFunctionLibrary {
     ...
     */
    UFUNCTION(BlueprintCallable, Category="Actor",  meta=(DeterminesOutputType="Interface", DynamicOutputParam="OutActors"))
    static void GetAllChildActorsWithInterface(const AActor* Actor, TSubclassOf<UInterface> Interface, bool bIncludeDescendants, TArray<AActor*>& OutActors);
