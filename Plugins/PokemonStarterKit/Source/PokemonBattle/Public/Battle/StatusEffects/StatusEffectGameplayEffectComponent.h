...
class POKEMONBATTLE_API UStatusEffectGameplayEffectComponent : public UGameplayEffectComponent {
  ...
  public:
    bool CanGameplayEffectApply(const FActiveGameplayEffectsContainer &ActiveGEContainer,
  ...
  private:
     ...
     */
    void OnGameplayEffectRemoved(const FGameplayEffectRemovalInfo &GERemovalInfo,
