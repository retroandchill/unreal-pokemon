...
FSingleTypeModData::FSingleTypeModData(const TScriptInterface<IBattler> &User, const TScriptInterface<IBattler> &Target,
    FName AttackingType, FName DefendingType, float Multiplier) : User(User), Target(Target), AttackingType(AttackingType), DefendingType(DefendingType), Multiplier(Multiplier) {
}

USingleTypeModPayload * USingleTypeModPayload::Create(const TScriptInterface<IBattler> &User, const TScriptInterface<IBattler> &Target, FName AttackingType, FName DefendingType, float Multiplier) {
