...
FAdditionalEffectChanceModificationData::FAdditionalEffectChanceModificationData(const TScriptInterface<IBattler> &User,
    const TScriptInterface<IBattler> &Target, int32 AdditionalEffectChance) : User(User), Target(Target), AdditionalEffectChance(static_cast<float>(AdditionalEffectChance)) {
}
