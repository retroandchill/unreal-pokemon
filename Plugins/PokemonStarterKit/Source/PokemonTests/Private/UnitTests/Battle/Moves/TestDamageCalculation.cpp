...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(TestDamageCalculation, "Unit Tests.Battle.Moves.TestDamageCalculation.PhysicalWeakNoCrit",
                                 EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool TestDamageCalculation::RunTest(const FString &Parameters) {
