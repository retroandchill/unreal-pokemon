...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(TestMoveInflictStatusEffect_MainEffect, "Unit Tests.Battle.Moves.TestMoveInflictStatusEffect.MainEffect",
...
bool TestMoveInflictStatusEffect_MainEffect::RunTest(const FString &Parameters) {
    ...
    AddExpectedMessage(TEXT("Snorlax didn't take any damage, skipping the additional effect chance!"), ELogVerbosity::Display);
    Action.Execute();
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(TestMoveInflictStatusEffect_AlreadyHas, "Unit Tests.Battle.Moves.TestMoveInflictStatusEffect.AlreadyHasStatus",
                                 EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(TestMoveInflictStatusEffect_AdditionalEffect, "Unit Tests.Battle.Moves.TestMoveInflictStatusEffect.AdditionalEffect",
                                 EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
...
bool TestMoveInflictStatusEffect_AdditionalEffect::RunTest(const FString &Parameters) {
    ...
    AddExpectedMessage(TEXT("Applying additional effect of Fire Blast to Snorlax"),
        ELogVerbosity::Display);
    Action.Execute();
