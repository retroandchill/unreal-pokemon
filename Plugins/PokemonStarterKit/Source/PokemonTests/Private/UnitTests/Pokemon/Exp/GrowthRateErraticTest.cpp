...
IMPLEMENT_COMPLEX_AUTOMATION_TEST(GrowthRateErraticTest, "Private.UnitTests.Core.Exp.GrowthRateErraticTest",
                                  EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

void GrowthRateErraticTest::GetTests(TArray<FString> &OutBeautifiedNames, TArray<FString> &OutTestCommands) const {
    OutBeautifiedNames.Add("Private.UnitTests.Core.Exp.GrowthRateErraticTest: Level = 1");
    OutTestCommands.Add("1");

    OutBeautifiedNames.Add("Private.UnitTests.Core.Exp.GrowthRateErraticTest: Level = 2-49");
    OutTestCommands.Add(FString::FromInt(FMath::RandRange(2, 49)));

    OutBeautifiedNames.Add("Private.UnitTests.Core.Exp.GrowthRateErraticTest: Level = 50");
    OutTestCommands.Add("50");

    OutBeautifiedNames.Add("Private.UnitTests.Core.Exp.GrowthRateErraticTest: Level = 51");
    OutTestCommands.Add("51");

    OutBeautifiedNames.Add("Private.UnitTests.Core.Exp.GrowthRateErraticTest: Level = 52-67");
    OutTestCommands.Add(FString::FromInt(FMath::RandRange(52, 67)));

    OutBeautifiedNames.Add("Private.UnitTests.Core.Exp.GrowthRateErraticTest: Level = 68");
    OutTestCommands.Add("68");

    OutBeautifiedNames.Add("Private.UnitTests.Core.Exp.GrowthRateErraticTest: Level = 69");
    OutTestCommands.Add("69");

    OutBeautifiedNames.Add("Private.UnitTests.Core.Exp.GrowthRateErraticTest: Level = 70-97");
    OutTestCommands.Add(FString::FromInt(FMath::RandRange(70, 97)));

    OutBeautifiedNames.Add("Private.UnitTests.Core.Exp.GrowthRateErraticTest: Level = 98");
    OutTestCommands.Add("98");

    OutBeautifiedNames.Add("Private.UnitTests.Core.Exp.GrowthRateErraticTest: Level = 99");
    OutTestCommands.Add("99");

    OutBeautifiedNames.Add("Private.UnitTests.Core.Exp.GrowthRateErraticTest: Level = 100");
