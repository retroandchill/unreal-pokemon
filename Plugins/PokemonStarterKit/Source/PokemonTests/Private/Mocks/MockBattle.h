...
class FMockBattle : public IBattle {
  ...
  public:
    ...
    MOCK_METHOD(UE5Coro::TCoroutine<EBattleResult>, ConductBattle, (APlayerController* Controller), (override));
    ...
    MOCK_METHOD(UE5Coro::TCoroutine<>, ExecuteAction, (IBattleAction & Action), (override));
