...
public:
    ...
    MOCK_METHOD(TScriptInterface<IBattler>, Initialize, (const TScriptInterface<IBattleSide> &Side,
        const TScriptInterface<IPokemon> &Pokemon, bool ShowImmediately), (override));
