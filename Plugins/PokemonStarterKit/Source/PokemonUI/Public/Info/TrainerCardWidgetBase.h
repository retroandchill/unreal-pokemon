...
#include "TrainerCardWidgetBase.generated.h"
...
/**
 * Base widget for displaying the contents of the trainer card
 */
UCLASS(Abstract)
class POKEMONUI_API UTrainerCardWidgetBase : public UCommonUserWidget {
    GENERATED_BODY()
