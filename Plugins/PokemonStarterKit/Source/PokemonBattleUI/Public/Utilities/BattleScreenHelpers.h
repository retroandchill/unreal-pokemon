...
public:
     ...
     */
    UFUNCTION(BlueprintCallable, Category = "Battle|Display")
    static UPokemonBattlePanel* FindPokemonBattlePanel(const UObject *WorldContextObject, const TScriptInterface<IBattler>& Battler);
    ...
    static void RefreshDisplayedStatusCondition(const UObject *WorldContextObject, const TScriptInterface<IBattler>& Battler);
