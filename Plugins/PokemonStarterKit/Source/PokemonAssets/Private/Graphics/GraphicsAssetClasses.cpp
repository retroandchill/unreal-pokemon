...
namespace Pokemon::Assets::Graphics {
    ...
    UE_DEFINE_ASSET_CLASS(TypeIconsSmall, FImageAsset, "/Game/Graphics/UI/Types/Icons", "types_");
    UE_DEFINE_ASSET_CLASS(StatusIcons, FImageAsset, "/Game/Graphics/UI/Statuses", "status_");
