...
/**
 * Contains a unique reference to a UObject and manages its memory through the root to protect it from Garbage
 * Collection. The object is released from the root (and later garbage collected if no UPROPERTY() fields reference it)
