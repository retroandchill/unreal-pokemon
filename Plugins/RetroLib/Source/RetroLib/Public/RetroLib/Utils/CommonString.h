...
namespace Retro {
     ...
     */
    RETROLIB_API FCommonString ExtractCommonStringFromProperty(const FProperty *Property, const uint8 *Data);
     ...
     */
    RETROLIB_API FStringView GetStringView(const FCommonString &String);
