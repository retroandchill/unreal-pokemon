...
#if CPP
UE_DECLARE_VARIANT_OBJECT_STRUCT(ImageAsset, UTexture2D, UTexture2DDynamic, UMaterialInterface, ISlateTextureAtlasInterface, UPaperFlipbook);
#else
USTRUCT(BlueprintType, NoExport, meta = (HiddenByDefault, DisableSplitPin))
struct FImageAsset {
    UPROPERTY(EditAnywhere,
        meta = (AllowedClasses="/Script/Engine.Texture2D,/Script/Engine.Texture2DDynamic,/Script/Engine.MaterialInterface,/Script/Engine.SlateTextureAtlasInterface,/Script/Paper2D.PaperFlipbook",
...
public:
    ...
    UFUNCTION(BlueprintPure, DisplayName = "Make Image Asset (Texture Dynamic)", Category = Variants, meta = (BlueprintAutocast))
    ...
    UFUNCTION(BlueprintPure, DisplayName = "Make Image Asset (Paper Flipbook)", Category = Variants, meta = (BlueprintAutocast))
