...
public:
    ...
    UE5Coro::TCoroutine<T*> PushWidgetToLayerStackAsync(FGameplayTag LayerName, TSoftClassPtr<T> ActivatableWidgetClass, bool bSuspendUntilInputComplete) {
        static const FName PushingToWidgetLayer = "PushingWidgetToLayer";
        const FName SuspendInputToken = bSuspendUntilInputComplete ?  UCommonUIExtensions::SuspendInputForPlayer(GetOwningPlayer(), PushingToWidgetLayer) : NAME_None;
