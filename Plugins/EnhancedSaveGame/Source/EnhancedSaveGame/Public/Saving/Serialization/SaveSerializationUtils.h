...
struct ENHANCEDSAVEGAME_API FObjectData {
     ...
     * handled. It is visible anywhere, can be read from Blueprints, saved in games, and categorized under "Serialization".
     */
     ...
     *
     * This method constructs a UObject from the serialized data stored in the FObjectData structure. It ensures that the
     * data is valid and the object can be properly reconstructed. If the ObjectClass is invalid or the data is empty,
