...
public:
     ...
     */
    UFUNCTION(BlueprintPure, Category = "Map|Grid", meta = (DefaultToSelf = "Character", AutoCreateRefTerm = "TargetSquare"))
    static bool InvalidFloor(ACharacter* Character, const FVector &TargetSquare, const UPrimitiveComponent *HitComponent);
