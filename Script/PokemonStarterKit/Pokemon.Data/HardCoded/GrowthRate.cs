...
public static partial class GrowthRateExtensions
{
    ...
    public static UGameDataManager AddGrowthRates(this UGameDataManager manager)
    {
        manager.GrowthRates.RegisterEntry(
            new FGrowthRate
            {
                ...
                ExpFormula = level => IntPow(level, 3),
            }
        );
        ...
        manager.GrowthRates.RegisterEntry(
            new FGrowthRate
            {
                ...
                // csharpier-ignore-end
                ExpFormula = level => (IntPow(level, 3) + level / 2 + 32) * 4 / (100 + level),
            }
        );
        ...
        manager.GrowthRates.RegisterEntry(
            new FGrowthRate
            {
                ...
                // csharpier-ignore-end
                ExpFormula = level =>
                    IntPow(level, 3) * 6 / 5 - 15 * IntPow(level, 2) + 100 * level - 140,
            }
        );
        ...
        manager.GrowthRates.RegisterEntry(
            new FGrowthRate
            {
                ...
                // csharpier-ignore-end
                ExpFormula = level => IntPow(level, 3) * 4 / 5,
            }
        );
        ...
        manager.GrowthRates.RegisterEntry(
            new FGrowthRate
            {
                ...
                // csharpier-ignore-end
                ExpFormula = level => IntPow(level, 3) * 5 / 4,
            }
        );
