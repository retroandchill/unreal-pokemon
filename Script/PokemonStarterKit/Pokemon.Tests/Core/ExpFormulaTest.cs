...
public class ExpFormulaTest
{
    ...
    private static readonly Dictionary<FGrowthRateHandle, ImmutableArray<int>> ExpGrowthCurve = new()
    {
        [FGrowthRate.Medium] =
        [
            -1,
    ...
    public void TestGetMinimumExpForLevel(
        [ValueSource(nameof(GrowthRateFormulas))] FGrowthRateHandle formula,
        [Values(1)]
        [DynamicRandom(2, 15)]
        [DynamicRandom(16, 35)]
        [DynamicRandom(36, 50)]
