...
public class MappingPbsSerializer<TModel, TOutput>(
    [ReadOnly] Func<TModel, TOutput> modelToOutput,
    [ReadOnly] Func<TOutput, TModel> outputToModel
) : IPbsSerializer<TOutput>
{
